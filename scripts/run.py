...
STAGE_TOOLS: dict[str, str] = {
    ...
    "s3_tests":     "Read,Grep,Glob,Write,Edit,Bash(uv init *),Bash(uv add *),Bash(uv sync *),Bash(uv lock *),Bash(uv run *),Bash(git init *),Bash(git add *),Bash(git commit *),Bash(git status *),Bash(git log *),Bash(git rev-parse *),Bash(grep *),Bash(mkdir *),Bash(ls *),Bash(cat *),Bash(cp *)",
